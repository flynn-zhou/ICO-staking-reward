            ...
            <div className="invest invest--big">
              ...
              <div className="row">
                <div className="col-12 col-lg-5">
                  <div className="incest__rate-wrap">
                ...
                <div className="col-12 col-lg-5 offset-lg-1">
                  <div className="invest__ratr-wrap">
                    <div className="invest__rate">
                      <span>Total Stake</span>
                      <p className="green">
                        {poolDetails?.depositToken.contractDappTokenBalance
                          .toString()
                          .slice(0, 10)}{" "}
                        {poolDetails?.depositToken.symbol}
                      </p>
                ...
                <div className="col-12 col-lg-5 offset-lg-1">
                  <div className="invest__ratr-wrap">
                    <div className="invest__rate">
                      <span>Total Stake</span>
                      <p className="green">1 FICOT = 0.00001 ETH</p>
                    </div>
              ...
              <p className="invest__info">
                ametconsectetur adipisicing elit.Dolorem sequi possimus qui,
                omnisreiciendis magni dicta laboriosamvoluptatem. Eum
                consequatur rationedoloremque aliquam maioresid perspiciatis
                adipisci culpa,voluptas iusto?
              </p>
            </div>
          </div>
        </div>
