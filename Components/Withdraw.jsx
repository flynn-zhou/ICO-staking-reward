...
const Withdraw = ({ poolDetails, setWithdrawPoolId }) => {
        ...
        <div className="row">
          <div className="col-12 col-md-8 offset-md-2 col-xl-6 offset-lg-3">
            <div className="section__title">
              ...
              <p>
                Lorem ipsum dolor sit zmet consectetur adipisicing elit.
                Expedita repellat vitae corrupti quaerat.
              </p>
            </div>
          </div>
        </div>
              ...
              <div key={index} className={`col-12 col-md-6 col-lg-4`}>
                <div className="node">
                  ...
                  <span className="node__price">
                    {" "}
                    <b>Reward:</b>
                    {pool?.userRewards} {pool?.rewardToken.symbol}
                  </span>
                  ...
                  <ul className="node__list">
                    <li>
                      ...
                      {pool?.depositTokenAddress.slice(0, 15)}...
                      <FaRegCopy />
                    </li>
                    <li>
                      <b>{pool?.rewardToken.symbol} &nbsp;&nbsp;</b>
                      {pool?.rewardTokenAddress.slice(0, 15)}...
                      <FaRegCopy />
                    </li>
                    <li>
                      <b>Current APY: &nbsp;</b>
